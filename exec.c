...
/**
  * concat_path - Concat path name and program name
  * @pathname: The path name to concat with the program name
  * @progname: The program name to place in the path name
  * Return: The path name concatd with the program name
  */
...
/**
  * find - Verify if command is found in the system
  * @cname: Command name to find in the system
...
/**
  * exec - Execs command
  * @cname: Command to execute
  * @opts: Options or flags to the command
